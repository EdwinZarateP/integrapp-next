...
const TODOS_LOS_DOCUMENTOS_DISPLAY = [
    ...
    { key: "documentoIdentidadConductorReverso", label: "Cédula Conductor (Reverso)" },
    { key: "licenciaReverso", label: "Licencia (Reverso)" },
    { key: "tarjetaPropiedadReverso", label: "Tarjeta Propiedad (Reverso)" },
